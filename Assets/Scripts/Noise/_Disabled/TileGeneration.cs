...
public class TileGeneration : MonoBehaviour
{
    ...
    private void Randomize()
    {
        ...
        this.levelScale = UnityEngine.Random.Range(10f, 100f);
        this.heightMultiplier = UnityEngine.Random.Range(1f, 10f);
        this.heightCurve = AnimationCurve.Linear(0f, 0f, 1f, 1f);
    }

    private Wave RandomizeWave()
    {
        Wave w = new Wave();
